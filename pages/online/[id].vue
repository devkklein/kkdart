          ...
          <div class="grid grid-flow-col py-4">
            <div class=" px-10 py-5">
              <div class="grid grid-flow-col w-full ">
                ...
                <div class=" w-full items-center justify-center bg-primary p-4 rounded-xl transition-transform duration-700 shadow-xl" :class="{ ' scale-110': currentPlayerIndex === 0 }">
                  ...
                  <div class="flex space-x-3 mt-4">
                    <div class="w-20 h-20 bg-secondary-300 shadow-xl rounded-xl flex items-center justify-center">
                      <div v-if="players[0].scores.dart1.multiplier" class="flex flex-col justify-center items-center ">
                      <div v-if="players[0].scores.dart1.value != 0" class="flex flex-col justify-center items-center">
                      <p class="text-3xl">{{ players[0].scores.dart1.value * players[0].scores.dart1.multiplier }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart1.multiplier === 1">S{{ players[0].scores.dart1.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart1.multiplier === 2">D{{ players[0].scores.dart1.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart1.multiplier === 3">T{{ players[0].scores.dart1.value  }}</p>
                    ...
                    <div class="w-20 h-20 bg-secondary-300 shadow-xl rounded-xl flex items-center justify-center">
                      <div v-if="players[0].scores.dart2.multiplier" class="flex flex-col justify-center items-center ">
                       <div v-if="players[0].scores.dart2.value != 0" class="flex flex-col justify-center items-center ">
                      <p class="text-3xl">{{ players[0].scores.dart2.value * players[0].scores.dart2.multiplier }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart2.multiplier === 1">S{{ players[0].scores.dart2.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart2.multiplier === 2">D{{ players[0].scores.dart2.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart2.multiplier === 3">T{{ players[0].scores.dart2.value  }}</p>
                    ...
                    <div class="w-20 h-20 bg-secondary-300 shadow-xl rounded-xl flex items-center justify-center">
                      <div v-if="players[0].scores.dart3.multiplier" class="flex flex-col justify-center items-center ">
                      <div v-if="players[0].scores.dart3.value != 0" class="flex flex-col justify-center items-center ">
                      <p class="text-3xl">{{ players[0].scores.dart3.value * players[0].scores.dart3.multiplier }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart3.multiplier === 1">S{{ players[0].scores.dart3.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart3.multiplier === 2">D{{ players[0].scores.dart3.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[0].scores.dart3.multiplier === 3">T{{ players[0].scores.dart3.value  }}</p>
            ...
            <div class=" px-10 py-5 border-l-2 border-primary ">
              <div class="grid grid-flow-col">
                <div class="w-full bg-primary p-4 rounded-xl transition-transform duration-700 shadow-xl" :class="{ ' scale-110': currentPlayerIndex === 1 }">
                  <div class="">
                    <div class="flex flex-col items-center justify-center">
                  ...
                  <div class="flex space-x-3 mt-4">
                    <div class="w-20 h-20 bg-secondary-300 shadow-xl rounded-xl flex items-center justify-center">
                      <div v-if="players[1].scores.dart1.multiplier" class="flex flex-col justify-center items-center ">
                      <div v-if="players[1].scores.dart1.value != 0" class="flex flex-col justify-center items-center ">
                      <p class="text-3xl">{{ players[1].scores.dart1.value * players[1].scores.dart1.multiplier }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart1.multiplier === 1">S{{ players[1].scores.dart1.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart1.multiplier === 2">D{{ players[1].scores.dart1.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart1.multiplier === 3">T{{ players[1].scores.dart1.value  }}</p>
                    ...
                    <div class="w-20 h-20 bg-secondary-300 shadow-xl rounded-xl flex items-center justify-center">
                      <div v-if="players[1].scores.dart2.multiplier" class="flex flex-col justify-center items-center ">
                       <div v-if="players[1].scores.dart2.value != 0" class="flex flex-col justify-center items-center ">
                      <p class="text-3xl">{{ players[1].scores.dart2.value * players[1].scores.dart2.multiplier }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart2.multiplier === 1">S{{ players[1].scores.dart2.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart2.multiplier === 2">D{{ players[1].scores.dart2.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart2.multiplier === 3">T{{ players[1].scores.dart2.value  }}</p>
                    ...
                    <div class="w-20 h-20 bg-secondary-300 shadow-xl rounded-xl flex items-center justify-center">
                      <div v-if="players[1].scores.dart3.multiplier" class="flex flex-col justify-center items-center ">
                      <div v-if="players[1].scores.dart3.value != 0" class="flex flex-col justify-center items-center ">
                      <p class="text-3xl">{{ players[1].scores.dart3.value * players[1].scores.dart3.multiplier }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart3.multiplier === 1">S{{ players[1].scores.dart3.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart3.multiplier === 2">D{{ players[1].scores.dart3.value  }}</p>
                      <p class="text-sm text-gray-300" v-if="players[1].scores.dart3.multiplier === 3">T{{ players[1].scores.dart3.value  }}</p>
