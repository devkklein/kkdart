<template>
  <div class="flex h-screen">
    ...
    <div class="w-full justify-center items-center p-10">
      <h1
        class="uppercase tracking-wider mb-2 px-2 opacity-70 font-bold mb-2 border-b-2 border-primary"
      >
        Create a new Match
      </h1>
      <form
      ...
      >
        ...
        <div
          class="flex justify-center space-x-4 border-b-2 border-primary py-6"
        >
          <button
            type="button"
            class="bg-secondary-300 border-2 rounded-lg p-4 w-1/4 hover:border-primary"
            :class="
              gameMode === 'x01' ? 'border-primary' : 'border-secondary-300'
            "
            @click="setMode('x01')"
          >
            X01
          ...
          <button
            ...
            class="bg-secondary-300 border-2 rounded-lg p-4 w-1/4 hover:border-primary"
            :class="
              gameMode === 'cricket' ? 'border-primary' : 'border-secondary-300'
            "
          ...
          <button
            ...
            class="bg-secondary-300 border-2 rounded-lg p-4 w-1/4 hover:border-primary"
            :class="
              gameMode === 'clock' ? 'border-primary' : 'border-secondary-300'
            "
            @click="setMode('clock')"
          >
            A round the Clock
          ...
          <button
            ...
            class="bg-secondary-300 border-2 rounded-lg p-4 w-1/4 hover:border-primary"
            :class="
              gameMode === '121' ? 'border-primary' : 'border-secondary-300'
            "
            @click="setMode('121')"
          >
            121
        ...
        <div class="flex w-full justify-between items-center mt-4">
          ...
          <button
            @click="createGame"
            type="button"
            class="bg-secondary-300 text-white rounded-lg p-2"
          >
            Create Game
          </button>
        </div>
