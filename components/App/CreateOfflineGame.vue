  ...
  <div class="flex h-full w-full justify-center items-center">
    ...
    >
      ...
      <div class="flex justify-center text-center items-center space-x-2">
        ...
        <div
          class="flex items-center justify-center bg-green-500 p-1 rounded-full"
        >
          <Icon
      ...
      <div class="flex flex-col justify-start items-center space-y-2 w-full">
        <div class="flex flex-col justify-center items-center space-y-2">
          ...
          <div
            class="bg-primary rounded-lg shadow-lg flex justify-center w-full"
          >
            <button
              type="button"
              :class="{ 'bg-secondary-300': basescore === 121 }"
              @click="setBaseScore(121)"
            >
              121
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': basescore === 170 }"
              @click="setBaseScore(170)"
            >
              170
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': basescore === 301 }"
              @click="setBaseScore(301)"
            >
              301
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': basescore === 501 }"
              @click="setBaseScore(501)"
            >
              501
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': basescore === 701 }"
              @click="setBaseScore(701)"
            >
              701
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': basescore === 901 }"
              @click="setBaseScore(901)"
            >
              901
            </button>
          </div>
        ...
        <div class="flex space-x-5">
          ...
          >
            ...
            >
              <button
                type="button"
                :class="{ 'bg-secondary-300': inMode === 'Single' }"
                @click="setInMode('Single')"
              >
                Single
              </button>
              <button
                type="button"
                :class="{ 'bg-secondary-300': inMode === 'Double' }"
                @click="setInMode('Double')"
              >
                Double
              </button>
              <button
                type="button"
                :class="{ 'bg-secondary-300': inMode === 'Master' }"
                @click="setInMode('Master')"
              >
                Master
              </button>
            </div>
          ...
          >
            ...
            >
              <button
                type="button"
                :class="{ 'bg-secondary-300': outMode === 'Single' }"
                @click="setOutMode('Single')"
              >
                Single
              </button>
              <button
                type="button"
                :class="{ 'bg-secondary-300': outMode === 'Double' }"
                @click="setOutMode('Double')"
              >
                Double
              </button>
              <button
                type="button"
                :class="{ 'bg-secondary-300': outMode === 'Master' }"
                @click="setOutMode('Master')"
              >
                Master
              </button>
            </div>
        ...
        <div class="flex flex-col justify-center items-center space-y-2">
          ...
          >
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 1 }"
              @click="setLegCount(1)"
            >
              1
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 2 }"
              @click="setLegCount(2)"
            >
              2
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 3 }"
              @click="setLegCount(3)"
            >
              3
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 4 }"
              @click="setLegCount(4)"
            >
              4
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 5 }"
              @click="setLegCount(5)"
            >
              5
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 6 }"
              @click="setLegCount(6)"
            >
              6
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 7 }"
              @click="setLegCount(7)"
            >
              7
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 8 }"
              @click="setLegCount(8)"
            >
              8
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 9 }"
              @click="setLegCount(9)"
            >
              9
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': legCount === 10 }"
              @click="setLegCount(10)"
            >
              10
            </button>
          </div>
        ...
        <div class="flex flex-col justify-center items-center space-y-2">
          ...
          >
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 1 }"
              @click="setSetCount(1)"
            >
              1
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 2 }"
              @click="setSetCount(2)"
            >
              2
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 3 }"
              @click="setSetCount(3)"
            >
              3
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 4 }"
              @click="setSetCount(4)"
            >
              4
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 5 }"
              @click="setSetCount(5)"
            >
              5
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 6 }"
              @click="setSetCount(6)"
            >
              6
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 7 }"
              @click="setSetCount(7)"
            >
              7
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 8 }"
              @click="setSetCount(8)"
            >
              8
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 9 }"
              @click="setSetCount(9)"
            >
              9
            </button>
            <button
              type="button"
              :class="{ 'bg-secondary-300': setCount === 10 }"
              @click="setSetCount(10)"
            >
              10
            </button>
          </div>
...
const players = ref<
  Array<{ id: any; username: string; profileImage: string | null }>
>([]);
