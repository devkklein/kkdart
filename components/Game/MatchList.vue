<template>
  <div class="h-full w-full flex flex-col items-center">
    ...
    <div v-else class="max-w-3xl w-full p-6 space-y-4 overflow-y-auto">
      ...
      <div v-if="matches.length === 0" class="flex flex-col items-center justify-center py-12 text-neutral-400">
      ...
      <div v-for="match in matches" :key="match.matchId"
        ...
        <div class="flex justify-between items-center mb-3">
          <div class="text-lg font-medium">Game #{{ match.matchId.substring(0, 8) }}</div>
          <div class="text-sm font-medium px-3 py-1 rounded-full bg-blue-900/30 text-blue-300">
            Available
          </div>
        </div>
        ...
        <button class="mt-2 w-full py-2 bg-secondary-300 hover:bg-secondary-400 text-white rounded-lg transition-colors"
